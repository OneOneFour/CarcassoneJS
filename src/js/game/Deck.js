...
class Deck {
  constructor(deck_template, seed, river_template) {
    ...
    let counts = Object.values(deck_template);
    this.deck = shuffled_arr_from_counts(counts, this.rng);

    if (typeof river_template !== 'undefined') {
      const non_river_length = this.unique_objects_defn_.length;
      // TODO:
      ...
      const river = shuffled_arr_from_counts(counts, this.rng, non_river_length);
